...
export default function ElevationProfile({ elevations, distanceKm }: ElevationProfileProps) {
  ...
  return (
    <div style={{
      ...
      <h3 style={{ margin: '0 0 15px 0', fontSize: isMobile ? '16px' : '18px', color: '#333' }}>
        📈 고도 프로필
      </h3>
      ...
      <div style={{
        ...
        <div>
          <div style={{ color: '#666', fontSize: isMobile ? '12px' : '14px', marginBottom: '5px' }}>
            최저 고도
          </div>
          <div style={{ fontSize: isMobile ? '16px' : '18px', fontWeight: 'bold', color: '#2196F3' }}>
        ...
        <div>
          ...
          <div style={{ fontSize: isMobile ? '16px' : '18px', fontWeight: 'bold', color: '#e74c3c' }}>
        ...
        <div>
          ...
          <div style={{ fontSize: isMobile ? '16px' : '18px', fontWeight: 'bold', color: '#27ae60' }}>
      ...
      <div style={{ marginTop: isMobile ? '15px' : '20px' }}>
        <div style={{ color: '#666', fontSize: isMobile ? '12px' : '14px', marginBottom: '10px' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            padding: isMobile ? '2px 4px' : '2px 5px',
            borderRadius: '3px'
          }}>
            {Math.round(maxElevation)}m
          </div>
